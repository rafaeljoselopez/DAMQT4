#ifndef FIELDLINESPAGE_H
#define FIELDLINESPAGE_H
...
class FieldLinesPage : public QWidget, public ILinesTabulationPage, public IExecutablePage
{
    Q_OBJECT
...
#include <functional>
    ...
    explicit FieldLinesPage(bool mpiAvailable, QWidget* parent = nullptr);
    ...
    void setLongRangeField(bool checked);
