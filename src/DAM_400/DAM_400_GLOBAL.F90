...
!------------------------------------------------------------------------
!
!	Modules for programs DAMSTO_400, DAMGTO_400, DAMDEN_400, DAMPOT_400, DAMFIELD_400, DAMFIELDPNT_400
!		DAMFRAD_400, DAMSTO_400_mpi, DAMGTO_400_mpi, DAMDEN_400_mpi, DAMPOT_400_mpi, DAMMULTROT_400,
!		DAMORB_400, DAMORB_400_mpi
!
...
!    eigvalmax, eigvalmed, eigvalmin: eigenvalues of geometry ellipsoid
...
!    wthreshold: threshold for contributions for the B integrals (see subroutine Avk)
     real(KREAL) :: eigvalmax, eigvalmed, eigvalmin, fct, wthreshold
