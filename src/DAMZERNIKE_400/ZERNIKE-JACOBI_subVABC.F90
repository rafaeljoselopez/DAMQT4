!  Copyright 2011-2026, Rafael Lopez
! 
...
!       Subroutines for computing radial factors of two center distributions
   subroutine fradAB(na, la, xxa, nb, lb, xxb, za, xb, zb)
    USE Zernike_Jacobi_STO_D, lmxc => lexpansion, rflm => rquadscal
    implicit none
...
! 
  subroutine subflmbas0(ldimaux, kmax, lmax, rinv, plm, fka, fkb, flmbas)
    USE Zernike_Jacobi_STO_D, only: KINT, KREAL, mxk, mxlckplm, mxkextra, mxlckplmextra, ckplm, ckplmextra
    implicit none
...
! 
  subroutine recurflm(ldim, lmaxtot, la, lb, r2, za, xb, zb, fin)
    USE Zernike_Jacobi_STO_D, fvoid => flm
    implicit none
    logical :: lcux
