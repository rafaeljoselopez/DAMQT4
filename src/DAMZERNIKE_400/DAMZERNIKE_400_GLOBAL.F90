...
!===============================================================================================
    MODULE Zernike_Jacobi_GTO_D
        ...
        real(KREAL), allocatable :: cfcontr(:), cfcontr0(:), xxg(:), xxg0(:), radfunction(:,:)
...
!		Pointers to the elements P_0^(L,-L; L',-L')
    ...
    END MODULE
!
!                 END OF MODULE Zernike_Jacobi_GTO_D
!...............................................................................................
!===============================================================================================
!                 MODULE Zernike_Jacobi_STO_D
!===============================================================================================
    MODULE Zernike_Jacobi_STO_D
        USE Zernike_Jacobi_D
        IMPLICIT NONE
        ...
        real(KREAL), allocatable :: sol(:), radderiv(:,:), radfunction(:,:)
    END MODULE
!
!                 END OF MODULE Zernike_Jacobi_STO_D
!...............................................................................................
!===============================================================================================
!                 MODULE DAMDENZERNIKE_400_D
!===============================================================================================
    MODULE DAMDENZERNIKE_400_D
        USE Zernike_Jacobi_D
        IMPLICIT NONE
        ...
        real(KREAL) :: planeA, planeB, planeC
