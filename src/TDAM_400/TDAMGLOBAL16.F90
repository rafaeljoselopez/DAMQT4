...
!------------------------------------------------------------------------
!
!	Modules for programs TDAMCOM16.F90, TDAMDEN16.F90, TDAMPOT16.F90, TDAMTOPO16.F90
!
...
!> @param [in] KINT Decides 4-byte integer. Moved from DAM_400_T    
!> @param [in] KINT8 Decides 8-byte integer. Moved from DAM_400_T    
!> @param [in] KREAL Decides double precision floating point number. Moved from DAM_400_T     
!> @param [in] KREAL4 Decides single precision floating point number. Moved from DAM_400_T     
...
!! Moved from DAMDEN_400_T and DAMPOT_400_T module. Other such logicals are
...
!         INTEGER(KINT), PARAMETER :: IOUT=151
        ...
        REAL(KREAL) :: FDISP
        REAL(KREAL) :: CNVG, BOXL, BOXG , BOXB, BOXT,STEPSZT,EXLN, ANGLE, drcutcp
        ...
        LOGICAL:: WIREFRAME, SOLIDSURF,ADDGUESS,EXDRAW 
        LOGICAL:: LDERIV2,LGRADIENT,LARGO,LEXACT, ISWINDOWS
        CHARACTER      :: DIRSEP
        CHARACTER(300) :: PROJECTNAME
        CHARACTER(256) :: FILENAME,GUESSFILE, filenamewin   ! Modified by Rafa
...
! 		integer(KINT), parameter :: mxlenpol = 10
	...
	END MODULE
!
!                 END OF MODULE DAM_400_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAM_400_DATA_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
...
! for overlap integrals with ellipsoidal coords
	...
	END MODULE
!
!                 END OF MODULE DAM_400_CONST_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAM_400_LEGENDRE_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
...
!	Data generated with notebook legendre_quadrature.nb
	...
	END MODULE
!
!                 END OF MODULE DAM_400_LEGENDRE_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAMDEN_400_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
!> @details Contains variables used by TDAMDEN_400_mpi.F90
	MODULE DAMDEN_400_T
        USE DAMINITIAL_T
		USE DAM_400_T
		IMPLICIT NONE
	...
	END MODULE
!
!                 END OF MODULE DAMDEN_400_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAMPOT_400_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
!> @details Contains variables used by TDAMPOT_400_mpi.F90
	MODULE DAMPOT_400_T
        USE DAMINITIAL_T
		USE DAM_400_T
		IMPLICIT NONE
