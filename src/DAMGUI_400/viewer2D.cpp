...
Viewer2D::Viewer2D(QString *name, QWidget *parent): QWidget(parent) {
    ...
    connect(grafica, &Plotter::deletefrad, this, &Viewer2D::deletefrad);
    connect(grafica, &Plotter::deletesghist, this, &Viewer2D::deletesghist);
...
//      mainWin settings
    ...
    connect(mainWin, &MainWindow2DViewer::hideplotter, this, &Viewer2D::hideplotter);
    mainWin->show();
}
...
void Viewer2D::page_contours_widgets()
{
    ...
    connect(BTNcontour, &QPushButton::clicked, this, &Viewer2D::importcntfile_dialog);
    ...
    connect(BTNactualizarcontour, &QPushButton::clicked, this, &Viewer2D::BTNactualizarcontour_click);
...
//        Contours labels
    ...
    connect(CHKcontourslabel, &QCheckBox::stateChanged, this, &Viewer2D::CHKcontourslabel_changed);

//            Contours label Font

    BTNfontcontourslabel = new QPushButton(QIcon(":/images/fonts48.png"),tr("Font"));

    connect(BTNfontcontourslabel, &QPushButton::clicked, this, &Viewer2D::BTNfontcontourslabel_click);
...
//            Contours label color
    ...
    connect(BTNcontourslabelcolor, &QPushButton::clicked, this, &Viewer2D::BTNcontourslabelcolor_clicked);
    ...
    connect(SPBtolerance,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBtolerance_changed);
    ...
    connect(SPBzerotolerance,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBzerotolerance_changed);
...
//        Contours colors
    ...
    connect(CHKmulticolor, &QCheckBox::stateChanged, this, &Viewer2D::CHKmulticolor_changed);
    ...
    connect(BTNpositivecontourcolor, &QPushButton::clicked, this, &Viewer2D::BTNpositivecontourcolor_clicked);
    ...
    connect(BTNnegativecontourcolor, &QPushButton::clicked, this, &Viewer2D::BTNnegativecontourcolor_clicked);
    ...
    connect(BTNzerocontourcolor, &QPushButton::clicked, this, &Viewer2D::BTNzerocontourcolor_clicked);
    ...
    connect(CHKtranspbg, &QCheckBox::stateChanged, this, &Viewer2D::CHKtranspbg_changed);
...
//    FRMcntpen->setVisible(false);
    ...
    connect(SPBcntpenwidth, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBcntpenwidth_changed);
...
//    FRMcontourstyle->setVisible(false);
    ...
    connect(RBTpossolid, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTposdashed, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTposdotted, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTposdashdot, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    ...
    connect(RBTnegsolid, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTnegdashed, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTnegdotted, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTnegdashdot, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    ...
    connect(RBTzerosolid, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTzerodashed, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTzerodotted, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
    connect(RBTzerodashdot, &QRadioButton::toggled, this, &Viewer2D::RBTcontpostyle_changed);
}
...
void Viewer2D::page_field_widgets()
{
    ...
    connect(BTNfield, &QPushButton::clicked, this, &Viewer2D::importfieldfile_dialog);

    CHKshowfield = new QCheckBox(tr("Show field lines"));
    CHKshowfield->setChecked(true);
    connect(CHKshowfield, &QCheckBox::stateChanged, this, &Viewer2D::CHKshowfield_changed);
...
//          Arrows
    ...
    connect(CHKarrows, &QCheckBox::stateChanged, this, &Viewer2D::CHKarrows_changed);
...
//          Arrows spacing
    ...
    SPBarrowssep->setMaximumWidth(100);
    SPBarrowssep->setSingleStep(10);
    SPBarrowssep->setValue(150);
    connect(SPBarrowssep,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBarrowssep_changed);
...
//          Arrows size
    ...
    SPBarrowssize->setMaximumWidth(100);
    SPBarrowssize->setSingleStep(5);
    SPBarrowssize->setValue(15);
    connect(SPBarrowssize,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBarrowssize_changed);
...
//          Arrows width
    ...
    SPBarrowswidth->setMaximumWidth(120);
    SPBarrowswidth->setSingleStep(1);
    SPBarrowswidth->setValue(6);
    connect(SPBarrowswidth,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBarrowswidth_changed);
...
//          Arrows skew
    ...
    SPBarrowsskew->setMaximumWidth(100);
    SPBarrowsskew->setSingleStep(1);
    SPBarrowsskew->setValue(6);
    connect(SPBarrowsskew,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBarrowsskew_changed);
...
//    SPBelinespenwidth_changed();
    connect(SPBelinespenwidth, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBelinespenwidth_changed);
...
void Viewer2D::page_sghistogram_widgets()
{
    ...
    connect(BTNsghist, &QPushButton::clicked, this, &Viewer2D::importhstfile_dialog);
...
//             Sigma histogram labels
    ...
    connect(CHKsghistlabel, &QCheckBox::stateChanged, this, &Viewer2D::CHKsghistlabel_changed);
    ...
    connect(BTNfontsghistlabels, &QPushButton::clicked, this, &Viewer2D::BTNfontsghistlabels_click);
...
//              Pen width
    ...
    connect(SPBsghistpenwidth, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBsghistpenwidth_changed);
...
//              Smoothing lines
    ...
    connect(CHKsmoothlines, &QCheckBox::stateChanged, this, &Viewer2D::CHKsmoothlines_changed);
    ...
    connect(SPBsmoothfactor, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBsmoothfactor_changed);
    BTNsmooth = new QPushButton();
    BTNsmooth->setText(tr("Apply"));
    connect(BTNsmooth, &QPushButton::clicked, this, &Viewer2D::BTNsmooth_click);
...
//              Partial histograms
    ...
    connect(CHKshowparthist, &QCheckBox::stateChanged, this, &Viewer2D::CHKshowparthist_changed);
...
//              Print histograms data to file
    ...
    connect(CHKprinthist, &QCheckBox::stateChanged, this, &Viewer2D::CHKprinthist_changed);

    BTNprinthist = new QPushButton(FRMprinthist);
    BTNprinthist->setText(tr("Print"));
    connect(BTNprinthist, &QPushButton::clicked, this, &Viewer2D::BTNprinthist_click);
    ...
    connect(BTNprthist, &QPushButton::clicked, this, &Viewer2D::BTNprthist_click);
...
//              Type of radial factor
    ...
    connect(BTNfrads, &QPushButton::clicked, this, &Viewer2D::importfradfile_dialog);
    ...
    connect(RBTradfactor, &QRadioButton::toggled, this, &Viewer2D::RBTfrad_changed);
    connect(RBTr2flm, &QRadioButton::toggled, this, &Viewer2D::RBTfrad_changed);
    connect(RBTr2l2flm, &QRadioButton::toggled, this, &Viewer2D::RBTfrad_changed);
...
//             Radial factors labels
    ...
    connect(CHKcurvelabel, &QCheckBox::stateChanged, this, &Viewer2D::CHKcurvelabel_changed);
    ...
    connect(BTNfontcurvelabels, &QPushButton::clicked, this, &Viewer2D::BTNfontcurvelabels_click);
...
//              Pen width
    ...
    grafica->setcntpenwidth(2);
    connect(SPBcurvespenwidth, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBcurvespenwidth_changed);
}
...
//           CPs
    ...
    connect(BTNcps, &QPushButton::clicked, this, &Viewer2D::importcpsfile_dialog);
    ...
    for (int i=0;i<max_cps;i++){
        ...
        connect(CHKcps[i], &QCheckBox::stateChanged, this, &Viewer2D::CHKcps_changed);
//        QRgb colorRgb = cpscolor[i].rgba();
        ...
        connect(BTNcolorcps[i],&QPushButton::clicked, this, &Viewer2D::BTNcolorcps_change);
    }
...
//         Ball radius
    ...
    connect(SPBcpsballradius,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBcpsballradius_changed);
...
//          Distance to plane tolerance
    ...
    connect(TXTdistancethreshold,&QLineEdit::textChanged,this,&Viewer2D::TXTdistancethreshold_changed);
}
...
void Viewer2D::page_basins_widgets()
{
    ...
    connect(BTNbasins, &QPushButton::clicked, this, &Viewer2D::importbasinsfile_dialog);

    CHKbasins = new QCheckBox(tr("Show basins"));
    CHKbasins->setChecked(false);
    connect(CHKbasins, &QCheckBox::stateChanged, this, &Viewer2D::CHKbasins_changed);
...
//         Pen width
    ...
    connect(SPBbasinspenwidth, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBbasinspenwidth_changed);
...
//         Basins frontier color
    ...
    connect(BTNbasinscolor, &QPushButton::clicked, this, &Viewer2D::BTNbasinscolor_clicked);
...
//    grafica->setTopMargin(max(50,2*fmsize.height()+20));
    ...
    connect(CHKtitle, &QCheckBox::stateChanged, this, &Viewer2D::CHKtitle_changed);

//      Title Font
    BTNedittitle = new QPushButton();
    BTNedittitle->setText(tr("Edit"));
    connect(BTNedittitle, &QPushButton::clicked, this, &Viewer2D::editar_title);
    connect(grafica, &Plotter::title_dialog,this, &Viewer2D::editar_title);
...
//      Position title
    ...
    connect(TXTxtitle,&QLineEdit::returnPressed,this,&Viewer2D::TXTxtitle_changed);
    connect(TXTytitle,&QLineEdit::returnPressed,this,&Viewer2D::TXTytitle_changed);
    connect(grafica,&Plotter::titleposChanged,this,&Viewer2D::TXTtitlepos_changed);
    CHKtitlebox = new QCheckBox(tr("Show/hide")+" "+tr("Box"));
    CHKtitlebox->setChecked(false);
    CHKtitlebox->setEnabled(true);
    connect(CHKtitlebox, &QCheckBox::stateChanged, this, &Viewer2D::CHKtitlebox_changed);
...
//    grafica->setBottomMargin(max(50,2*fmsize.height()+20));
    ...
    connect(CHKXlabel, &QCheckBox::stateChanged, this, &Viewer2D::CHKXlabel_changed);

//            X axis label Font
    BTNeditXlabel = new QPushButton();
    BTNeditXlabel->setText(tr("Edit"));
    connect(BTNeditXlabel, &QPushButton::clicked, this, &Viewer2D::editar_Xlabel);
    connect(grafica, &Plotter::Xlabel_dialog,this, &Viewer2D::editar_Xlabel);
...
//        Position X axis label
    ...
    connect(TXTxXlabel,&QLineEdit::returnPressed,this,&Viewer2D::TXTxXlabel_changed);
    connect(TXTyXlabel,&QLineEdit::returnPressed,this,&Viewer2D::TXTyXlabel_changed);
    connect(grafica, &Plotter::XlabelposChanged,this, &Viewer2D::TXTXlabelpos_changed);

    CHKXlabelbox = new QCheckBox(tr("Show/hide")+" "+tr("Box"));
    CHKXlabelbox->setChecked(false);
    CHKXlabelbox->setEnabled(true);
    connect(CHKXlabelbox, &QCheckBox::stateChanged, this, &Viewer2D::CHKXlabelbox_changed);
...
//    grafica->setRightMargin(max(50,fmsize.height()+fm.size( Qt::TextSingleLine, "xx" ).width()+20));
    ...
    connect(CHKYlabel, &QCheckBox::stateChanged, this, &Viewer2D::CHKYlabel_changed);

//            Y axis label Font
    BTNeditYlabel = new QPushButton();
    BTNeditYlabel->setText(tr("Edit"));
    connect(BTNeditYlabel, &QPushButton::clicked, this, &Viewer2D::editar_Ylabel);
    connect(grafica, &Plotter::Ylabel_dialog,this, &Viewer2D::editar_Ylabel);
...
//        Position Y axis label
    ...
    connect(TXTxYlabel,&QLineEdit::returnPressed,this,&Viewer2D::TXTxYlabel_changed);
    connect(TXTyYlabel,&QLineEdit::returnPressed,this,&Viewer2D::TXTyYlabel_changed);
    connect(grafica, &Plotter::YlabelposChanged,this, &Viewer2D::TXTYlabelpos_changed);
    ...
    connect(CHKYlabelhorizontal, &QCheckBox::stateChanged, this, &Viewer2D::CHKYlabelhorizontal_changed);
    ...
    connect(CHKYlabelbox, &QCheckBox::stateChanged, this, &Viewer2D::CHKYlabelbox_changed);
...
//        Aspect ratio
    ...
    connect(CHKaspectratio, &QCheckBox::stateChanged, this, &Viewer2D::CHKaspectratio_changed);
...
//        Zoom region
    ...
    connect(BTNexeczoomreg, &QPushButton::clicked, this, &Viewer2D::execzoomreg);
    connect(grafica, &Plotter::zoomChanged, this, &Viewer2D::zoom_changed);
    connect(grafica, &Plotter::moveToTop, this, &Viewer2D::emit_moveToTopPlotter);
...
//        Margins
    ...
    connect(SPBBottomMargin,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBBottomMargin_changed);
    ...
    connect(SPBLeftMargin,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBLeftMargin_changed);
    connect(grafica, &Plotter::Left_Margin_changed, this, &Viewer2D::SPBLeftMargin_changed);
    ...
    connect(SPBRightMargin,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBRightMargin_changed);
    ...
    connect(SPBTopMargin,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBTopMargin_changed);
    connect(grafica, &Plotter::MarginsChanged, this, &Viewer2D::set_SPBmargins);
...
//         Background color
    ...
    connect(BTNbkgcolor, &QPushButton::clicked, this, &Viewer2D::BTNbkgcolor_clicked);
...
//         Grid
    ...
    connect(BTNgridcolor, &QPushButton::clicked, this, &Viewer2D::BTNgridcolor_clicked);
    ...
    connect(CHKgrid, &QCheckBox::stateChanged, this, &Viewer2D::CHKgrid_changed);
    ...
    connect(RBTsolid, &QRadioButton::toggled, this, &Viewer2D::RBTsolid_changed);
    connect(RBTdashed, &QRadioButton::toggled, this, &Viewer2D::RBTsolid_changed);
...
//         Scales
    ...
    connect(CHKXscalebottom, &QCheckBox::stateChanged, this, &Viewer2D::CHKXscale_changed);
    CHKXscaletop = new QCheckBox(tr("Top"));
    CHKXscaletop->setChecked(false);
    CHKXscaletop->setEnabled(true);
    grafica->setshowXscaletop(false);
    connect(CHKXscaletop, &QCheckBox::stateChanged, this, &Viewer2D::CHKXscale_changed);
    ...
    connect(CHKYscaleleft, &QCheckBox::stateChanged, this, &Viewer2D::CHKYscale_changed);
    ...
    connect(CHKYscaleright, &QCheckBox::stateChanged, this, &Viewer2D::CHKYscale_changed);
    ...
    connect(CHKticks, &QCheckBox::stateChanged, this, &Viewer2D::CHKXscale_changed);
    connect(CHKticks, &QCheckBox::stateChanged, this, &Viewer2D::CHKYscale_changed);
...
//        Ticks
    ...
    connect(CHKautomaticticks, &QCheckBox::stateChanged, this, &Viewer2D::CHKautomaticticks_changed);
    ...
    connect(SPBXticks,QOverload<int>::of(&QSpinBox::valueChanged),grafica, &Plotter::Xticks_changed);
    ...
    connect(SPBXcifras,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBXcifras_changed);
    ...
    connect(SPBYticks,QOverload<int>::of(&QSpinBox::valueChanged),grafica, &Plotter::Yticks_changed);
    ...
    connect(SPBYcifras,QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBYcifras_changed);
...
//          Centers
    ...
    connect(CHKcenters, &QCheckBox::stateChanged, this, &Viewer2D::CHKcenters_changed);
...
//          Centers radius
    ...
    connect(SPBcenterradius, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBcenterradius_changed);
...
//            Centers color
    ...
    connect(BTNcenterscolor, &QPushButton::clicked, this, &Viewer2D::BTNcenterscolor_clicked);

//          Centers labels

    CHKcenterslabel = new QCheckBox(tr("Show centers labels"));
    CHKcenterslabel->setChecked(true);
    connect(CHKcenterslabel, &QCheckBox::stateChanged, this, &Viewer2D::CHKcenterslabel_changed);

//            Centers labels font

    BTNfontcenterslabel = new QPushButton(QIcon(":/images/fonts48.png"),tr("Font"));

    connect(BTNfontcenterslabel, &QPushButton::clicked, this, &Viewer2D::BTNfontcenterslabel_click);
...
//            Centers labels color
    ...
    connect(BTNcenterslabelcolor, &QPushButton::clicked, this, &Viewer2D::BTNcenterslabelcolor_clicked);
    ...
    connect(SPBshftcenterlabels, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBshftcenterlabels_changed);
...
//          Bonds
    ...
    connect(CHKbonds, &QCheckBox::stateChanged, this, &Viewer2D::CHKbonds_changed);
...
//          Bonds thickness
    ...
    connect(SPBbondswidth, QOverload<int>::of(&QSpinBox::valueChanged),this, &Viewer2D::SPBbondswidth_changed);
...
//          Bonds lenght tolerance
    ...
    connect(TXTbondthreshold,&QLineEdit::textChanged,this,&Viewer2D::TXTbondthreshold_changed);
...
//            Bonds color
    ...
    connect(BTNbondscolor, &QPushButton::clicked, this, &Viewer2D::BTNbondscolor_clicked);
...
void Viewer2D::page_capture_widgets()
{
    ...
    connect(BTNcaptura, &QPushButton::clicked, this, &Viewer2D::BTNcapture_click);
    ...
    connect(CHKtranspbgcapture, &QCheckBox::stateChanged, this, &Viewer2D::CHKtranspbgcapture_changed);
    ...
    connect(RBTscreendef, &QRadioButton::toggled, this, &Viewer2D::RBTscreendef_changed);

    RBTscaledef = new QRadioButton();
    RBTscaledef->setChecked(false);
    RBTscaledef->setText(tr("Scaled resolution"));
    connect(RBTscaledef, &QRadioButton::toggled, this, &Viewer2D::RBTscreendef_changed);

    RBTuserdef = new QRadioButton();
    RBTuserdef->setChecked(false);
    RBTuserdef->setText(tr("User defined"));
    connect(RBTuserdef, &QRadioButton::toggled, this, &Viewer2D::RBTscreendef_changed);
}
...
void Viewer2D::page_save_widgets()
{
    ...
    connect(BTNsaveSettings, &QPushButton::clicked, this, &Viewer2D::BTNsaveSettings_click);
    BTNretrieveSettings = new QPushButton();
    BTNretrieveSettings->setText(tr("Retrieve"));
    connect(BTNretrieveSettings, &QPushButton::clicked, this, &Viewer2D::BTNretrieveSettings_click);
...
void Viewer2D::importfieldfile_dialog()
{
    ...
    QString fileName = filedialog.getOpenFileName(this,tr("Open file ..."),ProjectFolder,
        tr("Import data from")+" *.field2D *.dengr2D;;"+
        tr("Electric field files")+" (*.field2D);;"+
...
//    grafica->setBottomMargin(max(50,2*fm.size( Qt::TextSingleLine, "0" ).height()+20));
    ...
    grafica->setLeftMargin(10);
    grafica->setRightMargin(10);
    grafica->Ylabelrect.moveCenter(QPoint(grafica->getLeftMargin() + grafica->Ylabelrect.width(), grafica->height()/2));
...
bool Viewer2D::readcntfile(QString filename)
{
    ...
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
            QMessageBox::warning(this, tr("readcntfile"),tr("File %1 cannot be read")
...
//    Initializes to false the curve and sigma hole histogram plot types
    ...
    else if (std::max(std::abs(zmaxcnt),std::abs(zmincnt)) < 1.e-7){
//        qDebug() << "Override cursor count:" << (QApplication::overrideCursor() != nullptr);
        QMessageBox::warning(this,tr("Viewer")+"2D",tr("The function is negligible on the surface ") );
        QApplication::restoreOverrideCursor();
        return false;
    }
...
//    qSort(levels->begin(),levels->end());
    ...
    QRegularExpression regex("_\\d{4}$");
    baseName.remove(regex);
    baseName.replace("_MO", "-o");
    int ini = baseName.length()-6;
    if (ini > -1){
        QString planesuffix(baseName.mid(ini,4));
        if (checkplanesuffix(planesuffix)){
            QString filelblsname = fileinfo.absolutePath()+"/"+baseName+".plane";
            QFile filelbls(filelblsname);
            if (!filelbls.open(QFile::ReadOnly | QFile::Text)) {
                    QMessageBox::warning(this, tr("readcntfile Plane "),tr("File %1 cannot be read")
...
bool Viewer2D::readfieldfile(QString filename)
{
    QFile file(filename);
    QString suf=QFileInfo(filename).suffix().toLower();
    if ((suf != "field2d") && (suf != "dengr2d")){
        QMessageBox::warning(this, tr("readfieldfile"),tr("Invalid extension of file %1. Must be .field2D or dengr2D")
                .arg(filename));
        QApplication::restoreOverrideCursor();
        return false;
    }
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
        QMessageBox::warning(this, tr("readfieldfile"),tr("File %1 cannot be read")
                                .arg(filename)+QString(":\n%1.").arg(file.errorString()));
        QApplication::restoreOverrideCursor();
        return false;
    }
...
//    Initializes to false the curve and sigma hole histogram plot types
    ...
    while (!in.atEnd()){
        ...
        if (readlines){
            if (xy.count() < 2){
                if (curve.count() > 1){
                    elines->append(curve);
                    maxCurveLength = max(maxCurveLength,curve.count());
                }
                curve.clear();
            }
            else{
    ...
    CHKbasins->setChecked(false);
    QApplication::restoreOverrideCursor();
    if (elines->count() < 1 || (elines->count() == 4 && maxCurveLength == 2)){
        QMessageBox::information(this,tr("DAMQT"),
            tr("No lines available\n"), QMessageBox::Ok, 0);
//        file.close();
//        QApplication::restoreOverrideCursor();
        return false;
    }
...
bool Viewer2D::readhstfile(QString filename)
{
    ...
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
            QMessageBox::warning(this, tr("readhstfile"),tr("File %1 cannot be read")
                                    .arg(filename)+QString(":\n%1.").arg(file.errorString()));
            QApplication::restoreOverrideCursor();
            return false;
    }
...
void Viewer2D::SPBsmoothfactor_changed(int value){
...
bool Viewer2D::readfradfile(QString filename)
{
    ...
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
            QMessageBox::warning(this, tr("readfradfile"),tr("File %1 cannot be read")
                                    .arg(filename)+QString(":\n%1.").arg(file.errorString()));
            QApplication::restoreOverrideCursor();
            return false;
    }
...
void Viewer2D::SPBcenterradius_changed(int value){
    if (grafica){
//        grafica->setcenterradius(SPBcenterradius->value());
        grafica->setcenterradius(value);
        grafica->refreshPixmap();
        grafica->update();
        emit moveToTop(viewernumber);
    }
...
void Viewer2D::TXTbondthreshold_changed(const QString &text){
    if (grafica){
        grafica->setbondsthr(text.toDouble());
        grafica->setbonds();
        grafica->update();
        emit moveToTop(viewernumber);
    }
...
bool Viewer2D::readcpsfile(QString filename)
{
    ...
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
        QMessageBox::warning(this, tr("readcpsfile"),tr("File %1 cannot be read")
                                .arg(filename)+QString(":\n%1.").arg(file.errorString()));
        QApplication::restoreOverrideCursor();
        return false;
    }
...
void Viewer2D::TXTdistancethreshold_changed(const QString &text){
    distthr = text.toDouble();
    if (plotcps){
        plot_cps();
    }
}
...
bool Viewer2D::readbasinsfile(QString filename)
{
    ...
    if (!file.open(QFile::ReadOnly | QFile::Text)) {
        QMessageBox::warning(this, tr("readbasinsfile"),tr("File %1 cannot be read")
                                .arg(filename)+QString(":\n%1.").arg(file.errorString()));
        QApplication::restoreOverrideCursor();
        return false;
    }
...
void Viewer2D::TXTxtitle_changed(){
    grafica->titlerect.moveCenter(QPoint(TXTxtitle->text().toInt(),TXTytitle->text().toInt()));
    grafica->update();
}
...
void Viewer2D::editar_title()
{
    ...
    connect(BTNfonttitle, &QPushButton::clicked, this, &Viewer2D::BTNfonttitle_click);
    ...
    connect(BTNcolortitlefont, &QPushButton::clicked, this, &Viewer2D::BTNcolortitlefont_clicked);
        
        
    QPushButton *BTNtitleOK = new QPushButton();
    BTNtitleOK->setText(tr("Accept"));
    connect(BTNtitleOK, &QPushButton::clicked, this, &Viewer2D::aceptar_title);
    QPushButton *BTNtitleCancel = new QPushButton();
    BTNtitleCancel->setText(tr("Cancel"));
    connect(BTNtitleCancel, &QPushButton::clicked, this, &Viewer2D::cerrar_title);
...
void Viewer2D::TXTxXlabel_changed(){
    grafica->Xlabelrect.moveCenter(QPoint(TXTxXlabel->text().toInt(),TXTyXlabel->text().toInt()));
    grafica->update();
}
...
void Viewer2D::editar_Xlabel()
{
    ...
    connect(BTNfontXlabel, &QPushButton::clicked, this, &Viewer2D::BTNfontXlabel_click);
    grafica->setfontXlabelcolor(fontXlabelcolor);
    ...
    connect(BTNcolorXlabelfont, &QPushButton::clicked, this, &Viewer2D::BTNcolorXlabelfont_clicked);
        
    QPushButton *BTNXlabelOK = new QPushButton();
    BTNXlabelOK->setText(tr("Accept"));
    connect(BTNXlabelOK, &QPushButton::clicked, this, &Viewer2D::aceptar_Xlabel);
    QPushButton *BTNXlabelCancel = new QPushButton();
    BTNXlabelCancel->setText(tr("Cancel"));
    connect(BTNXlabelCancel, &QPushButton::clicked, this, &Viewer2D::cerrar_Xlabel);
...
void Viewer2D::TXTxYlabel_changed(){
    grafica->Ylabelrect.moveCenter(QPoint(TXTxYlabel->text().toInt(),TXTyYlabel->text().toInt()));
    grafica->update();
}
...
//     lang = new IDIOMA();
    ...
    connect(BTNfontYlabel, &QPushButton::clicked, this, &Viewer2D::BTNfontYlabel_click);
    ...
    connect(BTNcolorYlabelfont, &QPushButton::clicked, this, &Viewer2D::BTNcolorYlabelfont_clicked);
    ...
    connect(BTNYlabelOK, &QPushButton::clicked, this, &Viewer2D::aceptar_Ylabel);
    QPushButton *BTNYlabelCancel = new QPushButton();
    BTNYlabelCancel->setText(tr("Cancel"));
    connect(BTNYlabelCancel, &QPushButton::clicked, this, &Viewer2D::cerrar_Ylabel);
...
void Viewer2D::SPBbasinspenwidth_changed(int value){
//    grafica->setbasinspenwidth(SPBbasinspenwidth->value());
    grafica->setbasinspenwidth(value);
    grafica->refreshPixmap();
    grafica->update();
    emit moveToTop(viewernumber);
}

void Viewer2D::SPBcntpenwidth_changed(int value){
//    grafica->setcntpenwidth(SPBcntpenwidth->value());
    grafica->setcntpenwidth(value);
    grafica->refreshPixmap();
    grafica->update();
    emit moveToTop(viewernumber);
}

void Viewer2D::SPBcurvespenwidth_changed(int value){
//    grafica->setcurvespenwidth(SPBcurvespenwidth->value());
    grafica->setcurvespenwidth(value);
    grafica->refreshPixmap();
    grafica->update();
    emit moveToTop(viewernumber);
}

void Viewer2D::SPBelinespenwidth_changed(int value){
    grafica->efieldpenwidth->clear();
    if (!elines) return;
    for (int i = 0 ; i < elines->count() ; i++ ){
//        grafica->efieldpenwidth->append(SPBelinespenwidth->value());
        grafica->efieldpenwidth->append(value);
    }
    grafica->refreshPixmap();
    grafica->update();
    emit moveToTop(viewernumber);
...
void Viewer2D::SPBsghistpenwidth_changed(int value){
//    grafica->setsghistpenwidth(SPBsghistpenwidth->value());
    grafica->setsghistpenwidth(value);
    grafica->refreshPixmap();
    grafica->update();
    emit moveToTop(viewernumber);
}
...
void Viewer2D::BTNsaveSettings_click(){
    ...
    if (!fileout.open(QFile::WriteOnly | QFile::Text)) {
            QMessageBox::warning(this, tr("BTNsaveSettings_click"),tr("File %1 cannot be opened")
    ...
    if (CHKsettingsfile->isChecked()){
        ...
        if (!v.empty()){
            ...
            for (int i = 0 ; i < filelist.length() ; i++){
                ...
                else if (suf == "field2d" || suf == "dengr2d"){
                    readfieldfile(file);
                    plot_field2D();
                    ProjectFolder = QFileInfo(file).path();
