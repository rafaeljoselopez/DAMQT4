#ifndef POTENTIALPAGE_H
#define POTENTIALPAGE_H
...
class PotentialPage : public QWidget, public IGridOptionsPage, public IXYZTabulationPage, public IExecutablePage
{
    Q_OBJECT
...
//    using DeltaCalculator = std::function<double(const char*, double, double)>;
    ...
    explicit PotentialPage(bool mpiAvailable, QWidget* parent = nullptr);
    ...
    bool isLongRangePotential() const;
    ...
    void setExactPotentialVisible(bool checked);
    void setExecEnabled(bool enabled);
    void setFittedPotential(bool checked);
    void setFullPotential(bool checked);
...
private:   
    ...
    // ---- Potential settings ----
    QGroupBox* potentialSettingsGroup_ = nullptr;
