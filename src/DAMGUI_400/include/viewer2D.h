...
//		QLine Edit functions
    void TXTbondthreshold_changed(const QString &text);
    void TXTdistancethreshold_changed(const QString &text);
...
// 		Spin boxes functions
    ...
    void SPBcenterradius_changed(int);
    void SPBbasinspenwidth_changed(int);
    void SPBcntpenwidth_changed(int);
    void SPBcpsballradius_changed(int);
    void SPBcurvespenwidth_changed(int);
    void SPBelinespenwidth_changed(int);
    void SPBBottomMargin_changed(int);
    void SPBLeftMargin_changed(int);
    void SPBRightMargin_changed(int);
    void SPBsghistpenwidth_changed(int);
    void SPBshftcenterlabels_changed(int);
    void SPBsmoothfactor_changed(int);
